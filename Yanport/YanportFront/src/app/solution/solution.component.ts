...
export class SolutionComponent implements OnInit {
  ...
  reset() {
    this.outputdata.x = null;
    this.inputdata.x = null;
    this.inputdata.y = null;
    this.inputdata.initialX = null;
    this.inputdata.initialY = null;
    this.inputdata.instructions = null;
    this.inputdata.orientation = null;
